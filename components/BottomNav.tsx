...
export default function BottomNav() {
  ...
  if (path.startsWith('/partner') || path.startsWith('/article') || path === '/home-decision-preview') return null;
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 safe-bottom">
      <div className="max-w-md mx-auto">
        <div
          className="flex items-center justify-center gap-4 border-t shadow-[0_-12px_34px_rgba(105,72,38,0.10)]"
